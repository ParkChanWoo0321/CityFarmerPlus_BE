...
public record FarmProfileCreateRequest(
        ...
        @NotNull(message = "농지 면적은 필수입니다.")
        @Min(value = 1, message = "농지 면적은 1평 이상이어야 합니다.")
    ...
    public FarmProfileCreateRequest(
        ...
        this(farmName, representativeName, contactNumber, farmAddress, cityCounty,
                crops, mainActivities, businessRegistrationNumber, 1);
    }
}
