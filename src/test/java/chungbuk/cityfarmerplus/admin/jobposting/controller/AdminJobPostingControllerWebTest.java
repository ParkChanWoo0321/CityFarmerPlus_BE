...
class AdminJobPostingControllerWebTest {

    @Autowired
    private MockMvc mockMvc;

    @MockitoBean
    private AdminJobPostingService jobPostingService;

    @MockitoBean
    private AdminJobPostingMatchingService matchingService;
    ...
    void listUsesStablePageResponseContract() throws Exception {
        ...
        when(jobPostingService.list(any())).thenReturn(new PageImpl<>(
                List.of(),
                PageRequest.of(1, 5),
                11
        ));
