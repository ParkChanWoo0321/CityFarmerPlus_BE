...
@Transactional
abstract class FarmOwnershipPersistenceContract {
    ...
    @Test
    void persistsSubmissionDocumentsAndExecutesProfileLockQuery() {
    ...
    @Test
    void rejectsDuplicateAttemptNumberForTheSameFarmProfile() {
        String uniqueValue = UUID.randomUUID().toString();
        User owner = userRepository.saveAndFlush(User.register(
                "farm_" + uniqueValue.substring(0, 20),
                "encoded-password",
